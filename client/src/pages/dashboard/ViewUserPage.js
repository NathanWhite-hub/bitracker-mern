...
import { updateUser } from "../../api/managerRoutes";
...
function ViewUserPage() {
  ...
  const [data, setData] = useState({
    id: location.state.user[0]._id,
    firstName: location.state.user[0].firstName,
    lastName: location.state.user[0].lastName,
    userName: location.state.user[0].userName,
    password: "",
    team: location.state.user[0].team,
    hasRoundingModule: location.state.user[0].hasRoundingModule,
    hasManagerModule: location.state.user[0].hasManagerModule,
  });
  ...
  const handleTextChange = (e) => {
    ...
    if (e.target.name === "hasManagerModule")
      toast.warning(
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    ...
                    checked={data.hasRoundingModule}
